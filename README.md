...
| Lofi 背景音乐 | 双源可选：本机内置 CC0 曲目，或 13 个在线电台直播流（按红、绿、黄、蓝四色主题分组）；彩键切换主题，上、下键切台；本机曲目播完随机换色，电台断流自动换台并带音量淡入淡出；可设进入 Kiosk 自动播放 |
| 遥控器导航 | D-pad / OK / 返回全覆盖；播放、暂停、快退、快进、停止等媒体键；彩键切换 Lofi 歌单 |
| 设置 | 播放间隔、相片填充、播放顺序、信息显示、相册排序、媒体范围、Lofi 自动播放与来源、服务器地址与实例重扫 |
