...
<p align="center">
  ...
  Photofield 自动发现 · 相册浏览 · 幻灯片 · 视频播放 · Lofi 背景音乐
</p>
...
- Lofi 背景音乐双源：内置 28 首离线曲目或在线电台直播流
...
| 能力 | 说明 |
| --- | --- |
| 自动发现 | 扫描已配置 Photofield 服务器的端口|
| 相册浏览 | 四列封面卡片；子目录自动展开为独立相册 |
| 照片网格 | 按服务端 wall 布局排布；从任意照片直接开始幻灯片播放 |
| 视频播放 | 查看器与幻灯片播放均以原始文件有声播放 |
| 幻灯片播放 | 可配播放间隔、填充模式和播放顺序 |
| Lofi 背景音乐 | 双源可选：本机内置 28 首离线曲目，或 13 个在线电台直播流（按红、绿、黄、蓝四色主题分组）；彩键切换主题，上、下键切台 |
...
- [lofi-radio-web](https://github.com/88lin/lofi-radio-web) — 在线电台直播流的选台参考
