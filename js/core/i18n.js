...
(function () {
  ...
  const DICT = {
    en: {
      ...
      "settings.lofiSource": "Lofi source",
      "settings.lofiSource.hint": "Bundled local tracks, or live radio streams (requires network)",
      "settings.lofiSource.local": "Local tracks",
      "settings.lofiSource.radio": "Live radio",
    ...
    "zh-CN": {
      ...
      "settings.lofiSource": "Lofi 来源",
      "settings.lofiSource.hint": "本机内置曲目，或在线电台直播流（需要网络）",
      "settings.lofiSource.local": "本机曲目",
      "settings.lofiSource.radio": "在线电台",
      "settings.host": "地址",
